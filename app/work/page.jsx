  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex " ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2 border border-red-500">
          {/* BIOGRAPHY CONTAINER */}
        ...
        {/* SVG CONTAINER */}
        <div className="hidden lg:block w-1/3  z-30 xl:w-1/2 border">
          <h2 className='sticky top-0 text-3xl'>BRAIN</h2>
        </div>
      </div>
    </motion.div>
  );
